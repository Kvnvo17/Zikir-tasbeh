window.Referrals = (function () {
  ...
  function openModal(info) {
    Modal.open(`
      ...
      <button class="btn block" style="margin-top:12px" id="copyRefBtn">\u{1F4CB} Nusxa olish</button>
      <p style="font-size:12px;color:#8a90a3;margin-top:12px">Taklif qilingan do'stlar: <b>${info.invited_count}</b></p>
    `);
